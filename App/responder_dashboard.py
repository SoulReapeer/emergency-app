...
class ResponderDashboard(QWidget):
    ...
    def init_ui(self):
        ...
        self.available_table.setHorizontalHeaderLabels(['ID', 'Type', 'Location', 'Severity', 'Reporter', 'Actions'])
        ...
        self.assignments_table.setHorizontalHeaderLabels(['ID', 'Type', 'Location', 'Severity', 'Status', 'Actions'])
    ...
    def load_data(self):
        ...
        for row, incident in enumerate(pending_incidents):
            ...
            self.available_table.setItem(row, 3, severity_item)
        ...
        for row, incident in enumerate(my_assignments):
            ...
            if incident.severity == 'low':
                ...
                severity_item.setBackground(QColor(231, 76, 60))
            severity_item.setForeground(QColor(255, 255, 255))
            self.assignments_table.setItem(row, 3, severity_item)
