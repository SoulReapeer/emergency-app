...
# 8-Emergency feedback for each incident type
emergency_feedback = {
    "medical": { # 8
...
def get_feedback_for_incident(incident_type):
    """Get emergency feedback for a specific incident type"""
    category = get_incident_category(incident_type)
    category_feedback = emergency_feedback.get(category, {})
    return category_feedback.get(incident_type, "Follow emergency procedures and await professional help.")
