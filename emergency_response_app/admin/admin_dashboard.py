...
class AdminDashboard(QWidget):
    ...
    def load_data(self):
        ...
        for row, incident in enumerate(incidents):
            ...
            code = (getattr(incident, 'priority', '') or "").upper()
            if code == "P1":
...
class IncidentDetailsDialog(QDialog):
    ...
    def init_ui(self):
        ...
        basic_layout.addRow("Priority:", QLabel(self.incident.priority or "N/A"))
...
class AssignResponderDialog(QDialog):
    ...
    def init_ui(self):
        ...
        layout.addRow(QLabel(f"Priority: {self.incident.priority or 'N/A'}"))
